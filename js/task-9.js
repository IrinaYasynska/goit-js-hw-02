...
function addLogin(allLogins, login) {
    ...
    else if (isLoginUnique(allLogins, login) !== true) { message = REFUSAL; }
...
// всех логинов и добавляемый логин как параметры и проверяет наличие login в массиве allLogins,
